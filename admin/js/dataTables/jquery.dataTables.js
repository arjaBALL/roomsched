...
(function ($, window, document) {
  ...
  var _aoSettings =
    $.fn.dataTableSettings; /* Short reference for fast internal lookup */
  ...
  $.fn.dataTable = function (oInit) {
    ...
    function _fnDraw(oSettings) {
      ...
      if (
        ...
        oSettings.fnPreDrawCallback.call(oSettings.oInstance, oSettings) ===
          false
      ) {
        return;
      }
    ...
    function _fnFeatureHtmlFilter(oSettings) {
      ...
      sSearchStr =
        sSearchStr.indexOf("_INPUT_") !== -1
          ...
          ? '<input type="text" />'
          : sSearchStr +
            ' <input type="text" placeholder="type here..." /><div class="srch"></div>';
      ...
      if (
        ...
        oSettings.aiDisplayMaster.sort(function (a, b) {
          ...
          for (i = 0; i < iSortLen; i++) {
            ...
            iTest = oSort[
              (sDataType ? sDataType : "string") + "-" + aaSort[i][1]
            ](
