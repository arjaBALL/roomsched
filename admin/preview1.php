	 ...
	 echo $row1['room'];
	  ?>
	    ...
	    <td width="120">
	  	   <font size="1">
		  <?php 
	  $result1=mysqli_query($conn,"select * from schedule where CYS like '%$CYS%' and semester like '%$semester%' and sy like '%$sy%' and type='' and day like '%Friday%' and time='12:30 pm' and time_end='1:30 pm' ")or die(mysqli_error());
	  $row1=mysqli_fetch_array($result1);
	 echo $row1['subject'];
	 echo '<br>';
	 echo $row1['teacher']; 
